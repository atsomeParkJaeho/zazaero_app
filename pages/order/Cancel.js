                ...
                <View style={[styles.Cancel]}>
                    <View style={[styles.Tab,flex]}>
                        <View style={[styles.InquiryTab_item]}>
                            <TouchableOpacity style={[styles.InquiryTab_link,styles.active_link]} onPress={()=>{navigation.navigate('취소내역')}} >
                                <Text style={[styles.InquiryTab_txt,styles.active_txt]}>취소내역</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={[styles.InquiryTab_item]}>
                            <TouchableOpacity style={[styles.InquiryTab_link]} onPress={()=>{navigation.navigate('반품내역')}} >
                                            ...
                                            <View style={[container]}>
                                                <View style={[flex_between]}>
                                                    <View style={[styles.wt4]}>
                                                        <TouchableOpacity style={styles.detail_btn} onPress={()=>{navigation.navigate('취소내역상세')}}>
                                                    ...
                                                    <View style="">
                                                        ...
                                                        <View style="">
                                                            ...
                                                            {/*결제금액*/}
                                                            {/*<View style={flex}>*/}
                                                            {/*    <Text style={[h12,styles.color1]}>환불금액 :</Text>*/}
                                                            {/*    <Text style={[ms1,h16]}>1,300,000</Text>*/}
                                                            {/*</View>*/}
                                                            {/*환불금액*/}
                                                        </View>
                                                    </View>
