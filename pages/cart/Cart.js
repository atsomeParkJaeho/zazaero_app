        ...
        axios.post('http://49.50.162.86:80/ajax/UTIL_app_order.php', {
            ...
            if (res) {
                ...
                if (result === 'OK') {
                    ...
                    console.log(query,'/ 쿼리1');
                    console.log(A_order,'/ 장바구니 목록 확인1');
                    // console.log();

                    let temp = A_order.map((val,idx)=>console.log(val.A_goods_list,' / 상품리스트'));
